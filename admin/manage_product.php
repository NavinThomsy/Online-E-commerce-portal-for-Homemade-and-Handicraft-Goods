...
if(isset($_GET['id']) && $_GET['id']!=''){
	...
	if($check>0){
		mysqli_query($con,"update product set categories_id='$categories_id',name='$name',mrp='$mrp',price='$price',qty='$qty',short_desc='$short_desc',description='$description',meta_title='$meta_title',meta_desc='$meta_description',meta_keyword='$meta_keyword' where id='$id'");
...
if(isset($_POST['submit'])){
	...
	if($_FILES['image']['type']!='' && ($_FILES['image']['type']!='image/png' && $_FILES['image']['type']!='image/jpg' && $_FILES['image']['type']!='image/jpeg')){
		$msg="Only JPG/JPEG/PNG image formats allowed";
	}
	if($msg==''){
		if(isset($_GET['id']) && $_GET['id']!=''){
